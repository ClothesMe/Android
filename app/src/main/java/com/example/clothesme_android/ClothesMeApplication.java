...
public class ClothesMeApplication extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sliderItems.add(new SliderItems(R.drawable.function1)); //기능 1
        sliderItems.add(new SliderItems(R.drawable.function1)); //기능 2
        sliderItems.add(new SliderItems(R.drawable.function1)); //기능 3
